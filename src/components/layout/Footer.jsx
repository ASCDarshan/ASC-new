...
const navigation = {
  ...
  contacts: [
    {
      name: "1 C Satyam Apartment, Vishwas Colony Alkapuri, Vadodara - 390007",
      href: null,
    },
    { name: "Phone: 9638544455", href: "tel:9638544455" },
    {
      name: "Email: support@anantsoftcomputing.com",
      href: "mailto:support@anantsoftcomputing.com",
    },
  ],
  social: [
    {
        ...
        <div className="py-12 lg:py-16">
          ...
          <div className="mt-12 border-t border-gray-200 pt-8">
            <p className="text-base text-gray-400 xl:text-center">
              &copy; {new Date().getFullYear()} Anant Soft Computing. All rights
              reserved.
            </p>
          </div>
        </div>
